...
Puzzle.create(clue: "👩‍🎤 🥩 👗", answer: "Lady Gaga", category: "Person", user_id: 1, likes: 0)
...
Puzzle.create(clue: "📼 🔪 📻 ⭐️", answer: "Video Killed the Radio Star", category: "Song", user_id: 1, likes: 0)
