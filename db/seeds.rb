...
Puzzle.create(clue: "🌴🦖🦕🌴", answer: "Jurassic Park", category: "Movie", user_id: 1, likes: 7)
Puzzle.create(clue: "🛣🤜🥊", answer: "Street Fighter", category: "Game", user_id: 3, likes: 1)
Puzzle.create(clue: "🦉 + 🐡", answer: "Hootie and the Blowfish", category: "Musician", user_id: 22, likes: 1)
Puzzle.create(clue: "🐍🐍 ✈️", answer: "Snakes on a Plane", category: "Movie", user_id: 3, likes: 0)
Puzzle.create(clue: "🛷🌹", answer: "Citizen Kane", category: "Movie", user_id: 2, likes: 10)
Puzzle.create(clue: "🐖🐖 👧🏻 🐉", answer: "Spirited Away", category: "Movie", user_id: 3, likes: 11)
Puzzle.create(clue: "∞📖 🐉🐺", answer: "Neverending Story", category: "Movie", user_id: 1, likes: 5)
Puzzle.create(clue: "🇨🇭💪🔪", answer: "Swiss Army Knife", category: "Thing", user_id: 3, likes: 2)
Puzzle.create(clue: "🍄🌻⭐️", answer: "Super Mario Bros.", category: "Game", user_id: 1, likes: 3)
Puzzle.create(clue: "🤠👨‍🚀🐷🦖🥔", answer: "Toy Story", category: "Movie", user_id: 3, likes: 10)
Puzzle.create(clue: "🌊👨‍👨‍👦‍👦👨‍👨‍👦‍👦👨‍👨‍👧 🎰💰", answer: "Ocean's Eleven", category: "Movie", user_id: 80, likes: 11)
Puzzle.create(clue: "🕯 🕰 🍵 🥀", answer: "Beauty and the Beast", category: "Movie", user_id: 2, likes: 9)
Puzzle.create(clue: "∞ ⚔️", answer: "Avengers: Infinity War", category: "Movie", user_id: 3, likes: 8)
